---
título: "Herramientas personalizadas para llamadas en curso"
...
<Note>
Las herramientas personalizadas durante la llamada permiten que tu asistente de IA interactúe con sistemas externos durante las llamadas. Ya sea para revisar el inventario, verificar los datos de los clientes o obtener información en tiempo real, estas herramientas hacen que tu IA sea más potente y esté más conectada.
</Note>
...
- Realiza llamadas a la API en tiempo real durante las conversaciones
- Obtenga o envíe datos a sus sistemas
- Tome decisiones informadas basadas en datos en tiempo real.
- Proporcionar información precisa y actualizada a las personas que llaman.

<Card title="Key Benefits" icon="star">
  - No se necesita programar: solo hay que configurar el punto final de la API y los parámetros. La IA sabe automáticamente cuándo y cómo utilizar las herramientas. Acceso a los datos en tiempo real durante las llamadas. Integración perfecta con tus sistemas actuales.
</Card>
...
## Realizar pruebas es más fácil que nunca.

<Card title="Automatic Testing" icon="vial">
Haga clic en "Herramienta de prueba" para ejecutar una prueba con datos ficticios:
...
## Función para usuarios avanzados: Integración de la plataforma de automatización
...
<Info>
  La IA necesita instrucciones claras en su sistema para utilizar eficazmente tus herramientas personalizadas.
</Info>
